...
const AssignSubjectsPage = () => {
  ...
  // Helper to handle delete (Placeholder for actual logic)
    ...
    <div className={styles.container}>
              ...
              {assignments.length > 0 ? (
                ...
                <tr>
                  <td colSpan="6" className={styles.emptyRow}>
                    No subject assignments found in the database.
                  </td>
                </tr>
              )}
            </tbody>
      ...
      <div className={styles.footer}>
        <Link href="/dashboard/kteacher/assignsubjects/gradesummary">
          <button className={styles.gradeSummaryBtn}>
            View Grade Summary
          </button>
        </Link>
      </div>
 ...
 * @param {string} icon - 'view', 'edit', or 'remove'
